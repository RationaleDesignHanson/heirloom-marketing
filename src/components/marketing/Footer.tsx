...
export default function Footer() {
  return (
    <footer className="border-t border-black/10 bg-[var(--cream)] pb-[env(safe-area-inset-bottom,0px)]">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-sm text-black/70">
            <span className="font-semibold text-black">Heirloom</span> — Recipe Box
          </div>
          <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-black/70">
