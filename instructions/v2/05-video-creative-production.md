...
**"Capture anything → Heirloom preserves it as heritage with credit → archived in your family recipe box → private by default."**

This is the through-line for every video asset. Show capture, show preservation, end with trust.

### Competitive Wedge

| Competitor | Their Position | Heirloom's Differentiation |
|------------|---------------|---------------------------|
| **Paprika** | Classic recipe manager, clip from web | Heritage-grade preservation + trust + sharing that sticks |
| **ReciMe** | Save from social platforms | Attribution + provenance + privacy-first preservation |
...
| Phrase | Use Case |
|--------|----------|
| "Preserve your family's recipes." | Universal CTA |
...
| "Preserve family recipes forever." | Emotional/Grandma |
...
- App Store badge
- CTA text: "Preserve your family's recipes."

**Optional additions:**
- "Start free. 50 credits included." (pricing clarity)
...
### Frame-by-Frame Storyboard (Corrected)

| Timecode | Segment | Visual | On-Screen Text | Capture ID | Transition |
|----------|---------|--------|----------------|------------|------------|
| 0:00–0:04 | Hook | Collections grid with populated recipes | "Your family's recipes, finally preserved" | `CAP_07B` | Fade in, slight zoom |
| 0:04–0:08 | Save | Share sheet → tap Heirloom → "Saved" toast | "Save in one tap" | `CAP_03` → `CAP_03B` → `CAP_11` | Cut |
| 0:08–0:13 | Video | Paste video URL → import progress → recipe result | "Even from videos" | `CAP_12` | Dissolve |
| 0:13–0:17 | Scan | Camera scan of cookbook page → extracted recipe | "Scan any cookbook" | `CAP_17` → `CAP_18` | Cut |
| 0:17–0:21 | Voice | Tap mic → speak → transcription appears | "Speak your recipe" | `CAP_22` | Dissolve |
| 0:21–0:25 | Trust | Privacy pills: Private by default | "Private by default" | `CAP_05` | Dissolve |
| 0:25–0:30 | CTA | Logo + App Store badge | "Download Heirloom" | End card | Dissolve |
...
| 0:12–0:15 | E | End card | "Preserve your family's recipes." |
...
**Differentiator:** Preserve / archive / legacy + voice dictation

| Time | Block | Visual | Text |
|------|-------|--------|------|
| 0:00–0:04 | A | Hands holding old recipe card (b-roll) | Hook text |
| 0:04–0:08 | — | Camera positions over card | — |
| 0:08–0:14 | B | Voice dictation: tap mic, speak recipe | "Speak it. Heirloom writes it." |
| 0:14–0:18 | C | Recipe appears, ingredients line by line | — |
| 0:18–0:22 | D | "Family" / "Heritage" source chip | "Saved with credit." |
| 0:22–0:26 | — | Collections with family collection | — |
| 0:26–0:30 | E | End card | "Preserve your family's recipes forever." |

**Captures needed:** `CAP_22`, `CAP_18`, `CAP_07B`
**B-roll needed:** Warm kitchen hands shot (generated or filmed)

---

### Variant 10: "Free Credits"

**Duration:** 15s
**Hook:** "50 free credits to start saving recipes."
...
| 0:06–0:10 | — | Subscription screen / credits balance | "50 credits to start. 100/month with Heritage." |
| 0:10–0:12 | — | Heritage features list | — |
...
| `CAP_02` | Onboarding Subscription (50 trial credits) | Screenshot | — | `captures/screenshots/CAP_02_onboarding_subscription.png` | SS_10, Landing |
...
| ~~`CAP_19`~~ | ~~Read Aloud~~ **(REMOVED — feature does not exist)** | — | — | — | — |
| `CAP_20` | Generator input (type ingredients) | **Recording** | **4-6s** | `captures/recordings/CAP_20_generator_input.mov` | V7, SS_06 |
| `CAP_21` | Credits balance / premium paywall | **Recording** | **4-5s** | `captures/recordings/CAP_21_credits_premium.mov` | V10, SS_10 |
| **`CAP_22`** | **Read Recipe: mic button + live transcription** | **Recording** | **6s** | `captures/recordings/CAP_22_read_recipe.mov` | **SS_05, App Store Preview, V09** |
...
> **Note:** The separate `CAP_V_VOICE_*` entries have been consolidated into `CAP_22` (Read Recipe). One capture covers the full voice dictation flow: mic button in recording state, live transcription, and duration timer.

| ID | Description | Used In | Setup |
|----|-------------|---------|-------|
| `CAP_22` | Read Recipe: mic + live transcription | SS_05, App Store Preview, V09 | Tap + > Read Recipe > start recording > dictate > capture during active transcription |

### AI-Generated Images

| ID | Description | Dimensions | Path | Used In |
|----|-------------|------------|------|---------|
| `AI_01` | Onboarding hero image | 1200 x 800 | `ai-generated/AI_01_onboarding_hero.png` | Onboarding Screen 1 |
...
| `SS_05` | Speak Your Recipe | `app-store/screenshots/SS_05_read_recipe.png` | `CAP_22` |
...
| `SS_10` | Start Free, Go Heritage | `app-store/screenshots/SS_10_premium.png` | `CAP_02` + `CAP_21` |
...
- `CAP_07B`, `CAP_03`, `CAP_03B`, `CAP_11`, `CAP_12`, `CAP_17`, `CAP_18`, `CAP_22`, `CAP_05`
...
1. `CAP_21` — Credits balance / premium paywall
2. `CAP_23` — Buy more credits

**Session 6: Camera (needs cookbook/recipe card prop)**
1. `CAP_17` — Camera scan UI

**Session 7: Voice (Read Recipe)**
1. `CAP_22` — Read Recipe: tap mic, dictate recipe, capture active recording with live transcription
...
- [ ] `CAP_02` — Onboarding Subscription (50 trial credits)
...
### Session 3: Recipe Results (4 captures)
...
### Session 5: Monetization (2 captures)

- [ ] `CAP_21` — Credits balance / premium paywall ($6.99/mo, $39.99/yr, $149 lifetime)
...
### Session 7: Voice — Read Recipe (1 capture)

- [ ] `CAP_22` — Read Recipe: tap mic, dictate recipe, capture active recording with live transcription
...
If time-constrained, capture these 17 first (covers all App Store screenshots + video + voice):
...
15. `CAP_22` — Read Recipe (voice dictation)
